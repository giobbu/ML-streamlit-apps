...
class GraphGCN:
    ...
    def prepare_streets_dataframe( self ):
        
        # lists of first and last point coordinates of street segments 
        ...
        # midpoint coordinates in street segment
    ...
    def build_graph_dataframe(self, streets_df, with_type, with_attr):
        df_streets = self.prepare_streets_dataframe()
    ...
    def save_graph_adjancency_pickle(self, H_, A_, name):
        with open(str(name) + '.pkl', 'wb') as f:
            pickle.dump([H_, A_], f)

    
    def vis_save_networkx(self, H, pos, un_direct):
    ...
    def save_html(self, H, pos, un_direct):
